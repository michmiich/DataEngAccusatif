...
# Dummy operator don't do anything in particular
# used to control shape of the dag
# task_id, which dag it depends to
task_one = DummyOperator(
    task_id='get_spreadsheet',
    dag=second_dag,
    trigger_rule='all_success',
    depends_on_past=False, #is there stake dependencies on success of other pipeline
)
